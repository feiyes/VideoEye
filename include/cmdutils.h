...
#if CONFIG_AVFILTER
/**
 * A callback to be used for AVFilterBufferRef.free.
 * @param fb buffer to free. fb->buf->priv must be a pointer to the FrameBuffer
 *           containing the buffer data.
 */
void filter_release_buffer(AVFilterBufferRef *fb);
#endif
